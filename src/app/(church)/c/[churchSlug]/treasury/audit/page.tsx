    ...
    <div className="space-y-6">
      ...
      <form method="get" className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3 xl:grid-cols-6">
          ...
          <div>
            <label htmlFor="entityType" className="mb-1 block text-sm font-medium text-slate-700">
              Entity
            </label>
            <select
              id="entityType"
          ...
          <div>
            <label htmlFor="actionType" className="mb-1 block text-sm font-medium text-slate-700">
              Action
            </label>
            <select
              id="actionType"
          ...
          <div>
            <label htmlFor="changedBy" className="mb-1 block text-sm font-medium text-slate-700">
              Actor
            </label>
            <select
              id="changedBy"
      ...
      {result.rows.length === 0 ? (
        <div className="rounded-xl border border-dashed border-slate-300 bg-white px-6 py-12 text-sm text-slate-600">
              ...
              <div key={row.id} className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
                <div className="border-b border-slate-200 bg-slate-50 px-4 py-3">
                  ...
                  <div className="mt-2 grid gap-2 text-sm text-slate-600 md:grid-cols-3">
                    ...
                    <div>
                      <span className="font-medium text-slate-900">Fields changed:</span>{" "}
                      {delta.length}
                    </div>
                  </div>
                ...
                <div className="px-4 py-4">
                  ...
                  <details className="mt-4 rounded-lg border border-slate-200 bg-slate-50">
                    ...
                    <div className="grid gap-4 border-t border-slate-200 px-4 py-4 lg:grid-cols-2">
                      <div>
                        <h3 className="mb-2 text-sm font-semibold text-slate-900">Before snapshot</h3>
...
{formatJson(row.before_snapshot)}
                      ...
                      <div>
                        <h3 className="mb-2 text-sm font-semibold text-slate-900">After snapshot</h3>
                        <pre className="max-h-96 overflow-auto rounded-md bg-slate-950 p-3 text-xs text-slate-100">
