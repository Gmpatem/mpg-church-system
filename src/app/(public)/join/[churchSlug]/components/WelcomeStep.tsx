    ...
    <div className="space-y-6 py-4 text-center sm:py-6">
      ...
      <div className="rounded-xl bg-stone-50 p-4 text-left text-sm text-stone-600">
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5">
          ...
          <li>This does not create a login account</li>
        </ul>
      </div>
      ...
      <button
        type="button"
        onClick={onNext}
        className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-emerald-800 px-6 text-sm font-semibold text-white transition hover:bg-emerald-900"
      >
